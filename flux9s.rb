class Flux9s < Formula
  ...
  on_macos do
    if Hardware::CPU.intel?
      url "https://github.com/dgunzy/flux9s/releases/download/v0.1.2/flux9s-macos-x86_64.tar.gz"
      sha256 "4a369aeab54b8d91a6f7caa9336fe7c21a01abc5ba541caf9976c8de69da1a51"
    elsif Hardware::CPU.arm?
      url "https://github.com/dgunzy/flux9s/releases/download/v0.1.2/flux9s-macos-aarch64.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.intel?
      url "https://github.com/dgunzy/flux9s/releases/download/v0.1.2/flux9s-linux-x86_64.tar.gz"
